...
import com.zhangz.security.enums.CommentTypeEnum;
import com.zhangz.security.enums.NotificationStatusEnum;
import com.zhangz.security.enums.NotificationTypeEnum;
...
public class CommentService {
    ...
    public List<CommentDTO> listByTargetId(Long id, CommentTypeEnum type) {
        ...
        userExample.createCriteria()
                .andIdIn(userIds);
        List<com.zhangz.security.model.User> users = userMapper.selectByExample(userExample);
